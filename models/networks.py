...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02, gpu_ids=[], not_mask=True, only_mask=False):
    """Create a generator
...
def define_D(input_nc, ndf, netD, n_layers_D=9, norm='batch', init_type='normal', init_gain=0.02, gpu_ids=[]):
...
class ResnetGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6, padding_type='reflect', not_mask=True, only_mask=False):
...
class ResnetGenerator_double(nn.Module):
    """Resnet-based generator that consists of Resnet blocks between a few downsampling/upsampling operations.
...
class ResnetGenerator_quad(nn.Module):
    """Resnet-based generator that consists of Resnet blocks between a few downsampling/upsampling operations.
